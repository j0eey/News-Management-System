    ...
    <div class="row py-4">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex justify-content-start">
                <a class="btn btn-lg btn-secondary btn-lg-square mr-2" href="#"><i class="fab fa-x-twitter"></i></a>
...
<div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
    <p class="m-0 text-center">&copy; <a href="#">2024 SPORTS NEWS </a>Powered By Joey. All Rights Reserved. 
</div>
<!-- Footer End -->
