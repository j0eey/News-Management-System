                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title">
                            <h4 class="m-0 text-uppercase font-weight-bold">Paris 2024</h4>
                        </div>
                    </div>
                </div>
                <!-- Football News will be dynamically added here -->
                <div id="paris2024_category"></div>
            </div>
...
<script src="{{ url('js/web/categories/api-paris2024.js') }}"></script>
@endpush